      ...
      *
       ...
       WORKING-STORAGE SECTION.
          77 WS-CRITICAL-SECTION PIC S9(18) USAGE COMP-5 VALUE 28.
          77 WS-CRITICAL-REGISTER PIC S9(18) USAGE COMP-5 VALUE 4.
          ...
          01 WS-HASHMAP PIC X(1) VALUE "N" OCCURS 100000000.
      ...
      *
       PART-1 SECTION.
          PERFORM RUN-PROGRAM-UNTIL-CRITICAL.
          MOVE WS-R (WS-CRITICAL-REGISTER) TO WS-PART-1-RESULT.
          DISPLAY "PART 1: " WS-PART-1-RESULT.
          EXIT.
      *
       PART-2 SECTION.
          PERFORM RUN-EQUIVALENT-PROGRAM-UNTIL-CYCLE.
          DISPLAY "PART 2: " WS-PART-2-RESULT.
          EXIT.
      *
       RUN-PROGRAM-UNTIL-CRITICAL SECTION.
          MOVE 0 TO WS-R (1).
          MOVE 0 TO WS-R (2).
          MOVE 0 TO WS-R (3).
          MOVE 0 TO WS-R (4).
          ...
          EXIT.
      *
       RUN-EQUIVALENT-PROGRAM-UNTIL-CYCLE SECTION.
          MOVE 0 TO WS-R (1).
          MOVE 0 TO WS-R (2).
          MOVE 0 TO WS-R (3).
          MOVE 0 TO WS-R (4).
          MOVE 0 TO WS-R (5).
          MOVE 0 TO WS-R (6).
       RUN-EQUIVALENT-PROGRAM-UNTIL-CYCLE-10.
          COMPUTE WS-R (3) = WS-R (4) B-OR 65536.
          MOVE 7637914 TO WS-R (4).
       RUN-EQUIVALENT-PROGRAM-UNTIL-CYCLE-50.
          COMPUTE WS-R (2) = WS-R (3) B-AND 255.
          COMPUTE WS-R (4) = WS-R (4) + WS-R (2).
          COMPUTE WS-R (4) = WS-R (4) B-AND 16777215.
          COMPUTE WS-R (4) = WS-R (4) * 65899.
          COMPUTE WS-R (4) = WS-R (4) B-AND 16777215.
          IF 256 > WS-R (3) THEN
             GO TO RUN-EQUIVALENT-PROGRAM-UNTIL-CYCLE-90
          END-IF.
          DIVIDE WS-R (3) BY 256 GIVING WS-R (2).
          MOVE WS-R (2) TO WS-R (3).
          GO TO RUN-EQUIVALENT-PROGRAM-UNTIL-CYCLE-50.
       RUN-EQUIVALENT-PROGRAM-UNTIL-CYCLE-90.
          MOVE WS-R (4) TO WS-T-1.
          IF WS-HASHMAP (WS-T-1) = "Y" THEN
             EXIT SECTION
          ELSE
             MOVE WS-T-1 TO WS-PART-2-RESULT
          END-IF.
          MOVE "Y" TO WS-HASHMAP (WS-T-1).
          GO TO RUN-EQUIVALENT-PROGRAM-UNTIL-CYCLE-10
          EXIT.
      *
